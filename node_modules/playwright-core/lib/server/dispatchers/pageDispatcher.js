...
class PageDispatcher extends import_dispatcher.Dispatcher {
  ...
  async agentPerform(params, progress) {
    return await (0, import_pageAgent.pageAgentPerform)(progress, this._page, params);
  }
  async agentExpect(params, progress) {
    await (0, import_pageAgent.pageAgentExpect)(progress, this._page, params);
  }
  async agentExtract(params, progress) {
    const { result, usage } = await (0, import_pageAgent.pageAgentExtract)(progress, this._page, params);
    return { result, ...usage };
  }
